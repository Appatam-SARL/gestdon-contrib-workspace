...
import { Archive, CheckCircle, Clock, EyeIcon, FileEdit } from 'lucide-react';
import Skeleton from 'react-loading-skeleton';

export default function StatsAudience({
  handleFilterChange,
  data,
  isLoadingStats,
  isRefetchingStats,
  ...
  handleFilterChange(key: keyof IAudienceFilterForm, value: any): void;
}) {
  return (
      ...
      {isLoadingStats || isRefetchingStats ? (
        ...
        <Card className='p-4 rounded-md hover:bg-primary group'>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            ...
            <FileEdit className='h-4 w-4 text-gray-500 group-hover:text-white' />
          </CardHeader>
          <CardContent>
            <div className='flex items-center'>
              <div className='flex-1'>
                ...
                <div className='flex items-center text-xs group-hover:text-white'>
                  <FileEdit className='h-3 w-3 mr-1 group-hover:text-white' />
                  Tous
                </div>
              </div>
              <div className='ml-2 flex flex-col text-right'>
