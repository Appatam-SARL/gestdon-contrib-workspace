...
const domaines = ["Politique", "Musique", "Sport", "Éducation", "Santé", "Culture"];
...
const OrganisationForm = () => {
  ...
  return (
    ...
    <div className="flex flex-col justify-between w-max-screen  bg-purple-100 relative overflow-hidden">
      ...
      <h1 className="text-2xl font-bold text-purple-700 mb-6 text-center">Informations sur votre organisation</h1>
      <form className="w-full max-w-2xl space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium mb-2">Bio / Présentation</label>
          <textarea
        ...
        <div>
          ...
          <input type="text" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:outline-none focus:ring-purple-500" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-2">Province / Région</label>
            <input type="text" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:outline-none focus:ring-purple-500" />
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input type="email" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:outline-none focus:ring-purple-500" />
          </div>
          <div>
            <label className="block text-sm font-medium mb-2">Téléphone</label>
            <input type="tel" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:outline-none focus:ring-purple-500" />
          </div>
        </div>
        <div className="text-sm text-gray-500 text-center">
          En cliquant sur « Enregistrer et continuer », vous acceptez nos <a href="#" className="text-purple-700 underline">Conditions d’utilisation</a> et reconnaissez avoir lu notre <a href="#" className="text-purple-700 underline">Politique de confidentialité</a>.
        </div>
